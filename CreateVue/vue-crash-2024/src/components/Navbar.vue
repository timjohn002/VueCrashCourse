...
const isActiveLink = (routePath) => {
  // this will get what is the current route and
  // checks if the passed in = to the actual route path in routing
          ...
          >
            ...
            <div class="md:ml-auto">
              <div class="flex space-x-2">
                ...
                <RouterLink
                  to="/dbView"
                  :class="[isActiveLink('/dbView')?'bg-green-900':'hover:bg-gray-900 hover:text-white','text-white' , 'rounded-md', 'px-3', 'py-2']"
                  >DB View</RouterLink
                >
              </div>
            </div>
